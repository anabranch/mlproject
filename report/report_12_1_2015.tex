...
\title{Applying Lessons for Natural Language Processing to better Approach Predictions with Large amounts of categorical variables.}
...
The data was previously published in \cite{yu_application_2010}
